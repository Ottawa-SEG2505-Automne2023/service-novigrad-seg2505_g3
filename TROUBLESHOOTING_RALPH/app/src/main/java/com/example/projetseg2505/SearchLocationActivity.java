...
public class SearchLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //test unitaire 4, valider le champ address
    ...
    private void performSearch() {
        ...
        Boolean validHours = validateHours(hoursQuery);
        //test unitaire 5, valider les heures
        Log.d("Prints", validHours.toString());
    ...
    private boolean validateHours(String hoursQuery) {
        if(!hoursQuery.isEmpty()){
            String[] time = hoursQuery.split(":");
            int hours = Integer.parseInt(time[0]);
            int minutes = Integer.parseInt(time[1]);
            int totalTime = hours * 60 + minutes;


            if(totalTime > 24 || totalTime < 0){
                return false;
            }
        }
