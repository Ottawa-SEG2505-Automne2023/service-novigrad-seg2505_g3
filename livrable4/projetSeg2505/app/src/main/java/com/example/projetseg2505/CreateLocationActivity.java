...
public class CreateLocationActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnCreateLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String locationName, locationAddress, openTime, closingTime, userName; //pour enregistrer les arguments, construire objet location
                ...
                Location newLocation = new Location(locationName, locationAddress, selectServices, openTime, closingTime, userNameFromIntent);
